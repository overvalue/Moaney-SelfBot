...
prefix = " " # Put prefix here for selfbot
client = commands.Bot(command_prefix=prefix,case_insensitive=True,self_bot=True)
client.remove_command('help')
token = " " # Put ur acc token here 
author = "Cord#1715"

versatile = pyfiglet.figlet_format(f"Cord On Top ")
print(versatile+f"\nMade By {author}\n")
